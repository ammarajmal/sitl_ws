...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/sitl2/sitl_ws/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /home/sitl2/sitl_ws/devel/.private/image_proc)
  ...
  set(image_proc_INSTALL_PREFIX /home/sitl2/sitl_ws/install)
...
if(NOT "/home/sitl2/sitl_ws/devel/.private/image_proc/include;/home/sitl2/sitl_ws/src/image_pipeline/image_proc/include;/usr/include/opencv4 " STREQUAL " ")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/sitl2/sitl_ws/devel/.private/image_proc/include;/home/sitl2/sitl_ws/src/image_pipeline/image_proc/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sitl2/sitl_ws/src/image_pipeline/image_proc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sitl2/sitl_ws/devel/.private/image_proc/lib;/home/sitl2/sitl_ws/devel/lib;/opt/ros/noetic/lib)
