...
if(NOT "/home/tesol/sitl_ws/devel/.private/stereo_image_proc/include;/home/tesol/sitl_ws/src/image_pipeline/stereo_image_proc/include " STREQUAL " ")
  set(stereo_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/tesol/sitl_ws/devel/.private/stereo_image_proc/include;/home/tesol/sitl_ws/src/image_pipeline/stereo_image_proc/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tesol/sitl_ws/src/image_pipeline/stereo_image_proc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tesol/sitl_ws/devel/.private/stereo_image_proc/lib;/home/tesol/sitl_ws/devel/lib;/home/tesol/ros_ws/devel/lib;/opt/ros/noetic/lib)
