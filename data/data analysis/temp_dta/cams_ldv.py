...
data['cam2_trans_x'] = data['cam2_trans_x'] * 1000
data['cam3_trans_x'] = data['cam3_trans_x'] * 1000
...
cam2_trans_x = data['cam2_trans_x'].values
cam3_trans_x = data['cam3_trans_x'].values
...
def align_signals(camera_data, ldv_data):
    ...
    lag = np.argmax(correlation) - (len(ldv_data) - 1)
    if lag > 0:
