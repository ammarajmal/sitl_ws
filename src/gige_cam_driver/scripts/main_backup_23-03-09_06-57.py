    ...
    def post_process_bag_file(self):
        ...
        while True:
            ...
            if camera_num == '1':
                ...
                # bag_file_path = f'/home/agcam/ros_ws/src/gige_cam_driver/bagfiles/detect_camera_{cam}_{dur}s_{now}.bag'
                # csv_file_path = f'/home/agcam/ros_ws/src/gige_cam_driver/data/detect_camera_{cam}_{dur}s_{now}.csv'                                
                ...
                # bag_file_path = f'/home/agcam/ros_ws/src/gige_cam_driver/bagfiles/detect_camera_{camera_num}_{str(dur)}s.bag'
                ...
                # data = pd.read_csv(f"/home/agcam/ros_ws/src/gige_cam_driver/data/detect_camera_{camera_num}_{dur}s.csv")
